...
public class MenuManagerPanelTeacherAbout : MonoBehaviour, MenuManager.IMenuManagerInterface
{
    ...
    void Start()
    {
        ...
        GameObject menu = m_menuManager.GetMenuGameObject(MenuManager.Menu.TeacherAbout);
