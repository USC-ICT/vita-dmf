...
public class MenuManagerPanelLocalAdminAbout : MonoBehaviour, MenuManager.IMenuManagerInterface
{
    ...
    void Start()
    {
        ...
        GameObject menu = m_menuManager.GetMenuGameObject(MenuManager.Menu.LocalAdminHubAboutVita);
