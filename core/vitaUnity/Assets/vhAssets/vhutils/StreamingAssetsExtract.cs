    ...
    public static bool ExtractStreamingAssets()
    {
        ...
        if (!m_streamingAssetsExtracted)
        {
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                WWW wwwFileList = VHFile.LoadStreamingAssets("fileList.txt");
                ...
                WWW wwwList = VHFile.LoadStreamingAssets("fileListExtract.txt");
                ...
                if (wwwList != null)
                {
                    ...
                    foreach (var s in split)
                    {
                        ...
                        WWW www = VHFile.LoadStreamingAssets(sTrim);
                        if (www != null)
                        {
                            m_fileList.Add(sTrim);
